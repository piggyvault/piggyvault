...
{
    public abstract class PiggyvaultWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static PiggyvaultWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(PiggyvaultWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<PiggyvaultDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<PiggyvaultDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<PiggyvaultDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<PiggyvaultDbContext, Task<T>> func)
        {
            T result;
